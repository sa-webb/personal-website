...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___author___degree'
  | 'siteMetadata___author___major'
  | 'siteMetadata___author___minor'
  | 'siteMetadata___author___profession'
  | 'siteMetadata___author___summary'
  | 'siteMetadata___author___description'
  | 'siteMetadata___description'
  | 'siteMetadata___siteUrl'
  | 'siteMetadata___social___spectrum'
  | 'port'
  | 'host'
  | 'polyfill'
  | 'pathPrefix'
...
export type SiteSiteMetadataSocial = {
  spectrum?: Maybe<Scalars['String']>;
};

export type SiteSiteMetadataSocialFilterInput = {
  spectrum?: Maybe<StringQueryOperatorInput>;
};
...
export type CategoryQueryQuery = { allMarkdownRemark: CategoryFragmentFragment };

export type LearningQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LearningQueryQuery = { allMarkdownRemark: CategoryFragmentFragment };

export type BlogHomeQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogHomeQueryQuery = { allMarkdownRemark: CategoryFragmentFragment };

export type TutorialsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type TutorialsQueryQuery = { allMarkdownRemark: CategoryFragmentFragment };

export type BioQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type BioQueryQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'summary'>>, social?: Maybe<Pick<SiteSiteMetadataSocial, 'spectrum'>> }> }> };

export type AdobeIconQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type AdobeIconQueryQuery = { icon?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }> };

export type GitHubIconnQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type GitHubIconnQueryQuery = { icon?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }> };

export type SpectrumIconQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type SpectrumIconQueryQuery = { icon?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }> };
...
export type Unnamed_1_Query = { site?: Maybe<{ siteMetadata?: Maybe<(
      ...
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'spectrum'>> }
    )> }> };

export type AuthorFragmentFragment = { siteMetadata?: Maybe<(
    Pick<SiteSiteMetadata, 'title'>
    & { author?: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'degree' | 'major' | 'minor' | 'profession' | 'description' | 'summary'>> }
  )> };

export type CategoryFragmentFragment = { edges: Array<{ node: (
...
export type IndexQueryQuery = { site?: Maybe<AuthorFragmentFragment>, icon?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
